...
class BaseModel():
    ...
    def validation(self, dataloader, current_iter, tb_logger, save_img=False, save_as_dir=False,dwt_levels=0,bs_j=0 ,wt_function= None, iwt_function= None):
        """Validation function.
        ...
        if self.opt['dist']:
            ...
            self.nondist_validation(dataloader, current_iter, tb_logger, save_img, save_as_dir,dwt_levels,bs_j,wt_function,iwt_function)
