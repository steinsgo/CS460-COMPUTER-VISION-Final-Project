...
def main():
    ...
    parser.add_argument('-c', '--config', type=str,default='/home/zhuqi/lyd/UHDformer-main/options/VAE/kl_f16.yaml', help='path to the config file')
    parser.add_argument('-w', '--weight', type=str,
                        default='/home/zhuqi/lyd/UHDformer-main/experiments/KL_16_32/models/net_g_latest.pth',
                        help='path for model weights')
    parser.add_argument('-o', '--output', type=str, default='/home/zhuqi/lyd/UHDformer-main/experiments/KL_16_32/lastest', help='Output folder')
    ...
    parser.add_argument('--tile_size', type=int, default=1536, help='Tile size for --test_tile')
    ...
    EnhanceNet = build_network(config).to(device)
    ...
    for idx, path in enumerate(paths):
        ...
        if args.test_tile:
            ...
            with torch.no_grad():
                import time
                t0 = time.time()
                output = EnhanceNet(img_tensor)[0]
                t1 = time.time()
                print('time:', t1-t0)
        output = output
